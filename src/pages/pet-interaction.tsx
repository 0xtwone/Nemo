      ...
      <div className="flex flex-col md:flex-row items-center bg-white rounded-lg shadow-lg p-6 max-w-4xl w-full">
        ...
        {selectedPet && (
          <div className="mb-6 md:mb-0 md:mr-6 flex-shrink-0">
            ...
            />
            <p className="mt-2 text-center pixel-font">{selectedPet.name}</p>
          </div>
        )}
        {/* 对话区域 */}
        <div className="flex-1">
          ...
          <div className="mb-4 space-y-3">
            {dialogStep === 1 && (
              <p className="pixel-font">Hey there, Master! I'm so excited that you chose me as your companion!</p>
            )}
            {dialogStep === 2 && (
